...
/*
 * Sample input for buffer overflow:
 * password 1: asdf
 * password 2: asdf
 * password 3: asdfadsfast
 * 
 * in third iteration, 
 * the attacker added extra t at the end overwriting the is_valid variable with 't' char
 * This allowed unauthorized access to the attacker.
 */
